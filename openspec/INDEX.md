...
<!-- opsx-init:rules:start —— 由 opsx-project-init 维护，勿手改本区块 -->
...
| 名称 | 文件 | 作用 |
|---|---|---|
| `workflow` | [workflow/workflow.md](./workflow/workflow.md) | 端到端流程总览：explore→ff→grill→/clear→评审→GATE→writing-plans→subagent-dev→代码审→opsx-done |
